package com.example.monivobe.domain.consumption.exception.code;
...
public enum ConsumptionSuccessCode implements BaseSuccessCode {

    FILE_UPLOAD_SUCCESS(HttpStatus.CREATED, "UPLOAD201_1", "성공적으로 파일을 저장했습니다."),
    CONSUMPTION_GET_SUCCESS(HttpStatus.OK, "CONSUMPTION200_1", "성공적으로 소비를 조회했습니다."),
